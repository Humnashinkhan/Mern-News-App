    ...
    <div className="min-h-[70vh] flex items-center justify-center animate-in fade-in zoom-in-95 duration-500">
      <div className="w-full max-w-md bg-[#1a1d24] border border-white/5 p-8 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.4)]">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm">Sign in to your HackerHub account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-indigo-500 hover:bg-indigo-600 text-white font-medium py-2.5 rounded-lg transition-all flex items-center justify-center gap-2 mt-2 disabled:opacity-70 shadow-[0_0_15px_rgba(99,102,241,0.2)]"
          >
